...
description: "Топ-16 содержательных комментариев на статью v2 от 14 апреля 2026 и мои ответы. Это история того, как концепт переписался в v4.0."
weight: 9
date: 2026-05-11
---
...
**Поменял:** Cd = 0,5 — это для тупого носа. Для острого конуса в гиперзвуке реально 0,15-0,2. Пересчитал — на 6,5 км/с было бы 180 g, всё равно много. В v4.0 урезал скорость до 2,5 км/с + добавил гелиевый буфер последних 2 км ствола. Мгновенное торможение упало до 4,5 g за 0,5 секунды.
...
**Поменял:** плазменное окно МГД выкинул целиком. На его место — комбинация гелиевого буфера (2 км ствола, градиент 0,01 → 1 атм) + расходной майларовой мембраны + быстрого клапана (AEDC-стандарт). Скорость звука в гелии 1019 м/с, число Маха капсулы падает с 7,3 до 2,45, q ÷ 7. Тепловой поток с 70 МВт/м² за 200 мс до 4,1 МВт/м² за 6-8 секунд — штатный режим PICA Stardust/Dragon. Прецеденты — газодинамические пушки на лёгком газе у лаборатория Сандиа и лаборатория ВМС США Dahlgren с 1960-х.
...
**Поменял:** одной ступени действительно не хватает. В v4.0 добавил бортовой ГПВРД (прямоточный гиперзвуковой) на воздушном дыхании в стратосфере. удельный импульс ~2000-3000, что снимает требование к массовому соотношению. Прецеденты: Циркон (Мах 9, РФ уровень готовности 9 military, эксплуатация с 2022), X-43A NASA (Мах 9,6, 2004), Hypersonix DART AE (Мах 5+, февраль 2026). Δv ~5 км/с от Мах 7 до Мах 22. Плюс малая твёрдотопливная на оставшиеся 0,3 км/с.
...
**Поменял в v4.0:** ни Ямантау, ни Народная не подходят. После 40 итераций с критиками площадка перенесена на Кольский полуостров (Ловозерские тундры).
...
### 13. Комментатор · «За $30 млрд лучше второй Уэбб»
