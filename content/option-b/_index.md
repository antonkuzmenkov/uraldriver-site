...
В комментариях на Хабре один читатель написал: «Возможно, это как-то может работать, если платформа находится в космосе или на Луне». Попадание в самое яблочко. На Луне нет атмосферы — нет drag, нет тепла, нет плазменных окон, гравитация в шесть раз ниже. Все претензии Хабр-критики исчезают разом.
...
| Escape velocity | 11,2 км/с (в орбиту через ГПВРД-ступень) | 2,4 км/с напрямую |
...
Lunar escape velocity 2,4 км/с — точно совпадает с тоннельной скоростью УД v3.2 (2,5 км/с). Это не случайно: O'Neill в 1976 году в Princeton SSI вычислил эти 2,4 км/с как нижний порог для лунного mass driver, и v3.2 в тоннеле на Земле даёт ровно эту скорость.
...
Ракета (включая Starship) хорошо доставляет грузы **с Земли**. Она не решает проблему «гравитационной развилки» цислунарной экономики: подъём из Земли требует Δv 11,2 км/с, подъём из Луны — Δv 2,4 км/с. Для устойчивой cislunar economy нужно научиться производить и забрасывать грузы прямо с Луны.
