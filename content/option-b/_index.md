...
![Лунная фаза 5 — масс-драйвер О'Нила: тоннель в реголите, без атмосферного обвеса, 2,38 км/с = вторая космическая, G→0](/img/v3_2/11_lunar_phase5.png)
...
![График Мецгера UCF 2024: r (масса продукта / масса оборудования) и G (передаточное отношение по стоимости транспорта капитала). Лунная фаза УД: G → 0, r растёт за счёт исчезновения теплозащиты и гелиевых буферов](/img/v3_2/04_metzger_rg.png)
