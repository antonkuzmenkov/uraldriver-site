...
CAPEX вырос с 30 миллиардов (версия 4.0) до 39,2 миллиарда (версия 4.2) из-за добавления 5-километрового участка реверсного торможения сабота, завода-сателлита для серийного производства спутников «УД-class» и резерва инфляции. В версии 4.3 (15 мая 2026) пересмотр по узлам после кросс-валидации с инженерным сообществом дал экономию 11 миллиардов: внешняя стальная труба разделена с внутренним маглев-треком (Invar/CFRP сегменты на пьезо-актюаторах), за счёт чего ушло заглубление со 100 до 50 метров; ВТСП-лента «СуперОкс» по контракту на 180 километров получила цену 50 долларов за метр; криогеника осталась на жидком азоте 77 К без перехода на MgB₂; ниокровская часть выделена отдельной строкой.
...
| Первый рой 1000 спутников SAR (ГОЗ) | 1,0 | 4% |
