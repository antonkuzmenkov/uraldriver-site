...
![Циклограмма квенча: разрез секции (NbTi 4,2 К + резистивный шунт + N+2 резерв), график тока T+0…T+50 мс, прецедент CERN LHC](/img/v3_2/13_quench_magnet.webp)
...
4. **Двухфазная архитектура (Земля → Луна)** — лунная фаза 2 как стратегический хедж от провала земного цислунарная спроса.
