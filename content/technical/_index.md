...
> Версия v3.2 (май 2026). Шлюз vacuum→atmosphere решён через гелиевый буфер последних 2 км + кевларовую мембрану + Fast-Acting Valve. Скорость в тоннеле снижена с 6,5 до 2,5 км/с. См. [главу 12](https://github.com/antonkuzmenkov/uraldriver-site/blob/master/concept-document/chapters/12_v3_2_pivot.md).
...
|---|---|---|---|---|
| T+0 сек | 1700 м н.у.м., начало тоннеля | 0 м/с | Старт LSM-разгона | 8 g axial |
...
![Drag-spike профиль: ствол маглева в разрезе, перегрузка 8 g sustained → 4,5 g spike в гелиевом буфере → плавное затухание; динамическое давление q ÷ 7 за счёт гелия](/img/v3_2/01_drag_spike_profile.png)

![Гелиевый буфер и дульный интерфейс: разрез последних 2,5 км ствола с градиентом давления, кевларовой мембраной и Fast-Acting Valve](/img/v3_2/08_gun_detail_v3_2.png)

![Полётный профиль T+0 → T+270 сек: высота, скорость, перегрузка по событиям пуска](/img/v3_2/09_flight_profile.png)

![Каскад скоростей: маглев +2,5, гелий −0,05, мембрана −0,15, атмосфера −0,80, ПВРД +5,0, ракета +1,3, орбита 7,8 км/с](/img/v3_2/07_velocity_waterfall.png)

В стволе перегрузка 8 g sustained 32 секунды — режим manned-friendly (космонавтов на центрифуге тренируют до 9 g по минуте). На входе в гелиевый буфер перегрузка падает до нуля (нет тяги). Drag-spike при пробитии кевларовой мембраны — **4,5 g за 0,5 секунды**, не 450 g (это была ошибка v1 с Cd=0,5, реальный Cd острого конуса 0,18). Динамическое давление в гелии в 7 раз ниже атмосферного — гелий тормозит, не разрушает.
...
## 5. Helium-Buffered Exit (гелиевый буфер на границе)

Главная замена в v3.2. Ранний концепт высокотехнологичного шлюза на границе vacuum/atmosphere (TRL 2 по факту — Hershcovitch BNL 1995 работал на квадратных сантиметрах для электронно-лучевой сварки) снят с архитектуры. На его место — комбинация трёх отработанных техник:
