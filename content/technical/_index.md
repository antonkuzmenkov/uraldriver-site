...
description: "Параметры тоннеля, маглев-системы, энергетики, капсулы и гелиевый буфер на выходе (v4.3)"
weight: 25
cascade:
  showAuthor: true
  showDate: true
...
Полное техническое описание — в [главе 3 концепт-документа](https://github.com/antonkuzmenkov/uraldriver-site/blob/master/concept-document/chapters/03_technical_design.md), история изменений v3.2 → v4.0 → v4.3 — в [журнале изменений](/changelog/).
