...
> Версия v3.2 после критики на Хабре. Скорость в тоннеле снижена с 6,5 до 2,5 км/с (Mach 7,3), перегрузка с 50–100 g до 8 g sustained. Шлюз vacuum→atmosphere решён через гелиевый буфер последних 2 км ствола + кевларовую мембрану + Fast-Acting Valve. Подробности — в [главе 12 концепт-документа](https://github.com/antonkuzmenkov/uraldriver-site/blob/master/concept-document/chapters/12_v3_2_pivot.md).
...
![Профиль перегрузок и динамического давления: 8 g sustained 32 сек на разгоне, drag-spike 4,5 g на дульном срезе, q ÷ 7 за счёт гелия — карта совместимости с разными типами груза](/img/v3_2/01_drag_spike_profile.png)
