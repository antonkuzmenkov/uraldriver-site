...
![Архитектура Урал-Драйвер v3.2: гора Народная, тоннель 40 км в разрезе, VVER + SMES + LSM + гелиевый буфер + кевларовая мембрана + капсула со scramjet](/img/v3_2/02_architecture_v3_2.webp)
...
![Профиль перегрузок и динамического давления: 8 g 32 сек на разгоне, drag-spike 4,5 g на дульном срезе, q ÷ 7 за счёт гелия — карта совместимости с разными типами груза](/img/v3_2/01_drag_spike_profile.webp)
