...
| Перегрузка на разгоне | 8 g продольных |
...
Перегрузка 8 g 32 сек + drag-spike 4,5 g на выходе — это режим, пригодный для пилотируемых, но со специфическими ограничениями для оптики и тонкой аппаратуры. Подходит:
