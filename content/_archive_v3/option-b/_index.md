...
description: "Земная маглев-катапульта 2030–2045 как первый шаг, лунный катапульта O'Neill 2045+ как естественное продолжение"
weight: 50
cascade:
  showAuthor: true
  showDate: true
...
![Лунная фаза 5 — масс-драйвер О'Нила: тоннель в реголите, без атмосферного обвеса, 2,38 км/с = вторая космическая, G→0](/img/v3_2/11_lunar_phase5.webp)
...
![График Мецгера UCF 2024: r (масса продукта / масса оборудования) и G (передаточное отношение по стоимости транспорта капитала). Лунная фаза УД: G → 0, r растёт за счёт исчезновения теплозащиты и гелиевых буферов](/img/v3_2/04_metzger_rg.webp)
